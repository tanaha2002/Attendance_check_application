...
public class ThongKeLuongCN extends javax.swing.JPanel {
     ...
     * 
     */
    private JpnBieuDo bieuDo;
    private ThongKeCongNhanDAO thongKeCongNhanDAO;
...
//	      lblDenThang.setForeground(Color.DARK_GRAY);
    ...
    public ThongKeLuongCN() {
        ...
        thongKeCongNhanDAO = new ThongKeCongNhanDAO();
        initComponents();
//        bieuDo = new JpnBieuDo(BarChart,CurveChart);
        themSuKien();
    ...
    private void themSuKien() {
        ...
        // add an item listener to the first combo box
        ...
        System.out.println(".actionPerformed()");
                ...
                if (selected.equalsIgnoreCase("Thống kê theo tháng")) {
                    ...
                    cmbTuThang.repaint();
                    tatComboboxDenThangNam();
                cmbTieuChi2.setModel(new DefaultComboBoxModel<String>(new String[]{"Top 5 công nhân lương cao nhất", "Top 5 công nhân lương thấp nhất"}));
            } 
            else if(cmbLoaiThongKe.getSelectedItem().toString().trim().equalsIgnoreCase("Thống kê theo khoảng thời gian"))
                {
                    batComboboxDenThangNam();
                    cmbTuThang.enable();
                    cmbTuThang.repaint();
                    cmbTieuChi2.setModel(new DefaultComboBoxModel<String>(new String[]{"Tổng lương","Top 5 công nhân lương cao nhất", "Top 5 công nhân lương thấp nhất"}));
...
//        cmbLoaiThongKe.getActionListeners()[0].actionPerformed(new ActionEvent(cmbLoaiThongKe, ActionEvent.ACTION_PERFORMED, ""));
        btnHuongDan.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				private void btnHuongDanActionPerformed(ActionEvent evt) throws Exception {
			        ImageIcon imageIcon = new ImageIcon(setting.PathSetting.PATH_IMAGE_HUONGDAN + "ThongKeCongNhan.jpg");
			        ...
			        JOptionPane.showMessageDialog(null, scrollPane, "Hướng dẫn thống kê lương công nhân", JOptionPane.PLAIN_MESSAGE);
				}
			});
...
//                String tieuChi = "Thống kê top 5 công nhân lương cao nhất";
                ...
                bieuDo = new JpnBieuDo(BarChart,LineChart,loaiThongKe,tieuChi1,tieuChi2);
                if(loaiThongKe.equalsIgnoreCase("Thống kê theo tháng")){
                    bieuDo.ThemDuLieuBieuDo(thongKeCongNhanDAO.topNamCongNhanTheoLuong(tieuChi1,tieuChi2, tuThang,tuNam));
                    ...
                    if(tieuChi1.equalsIgnoreCase("Lương")){
                        if(tieuChi2.equalsIgnoreCase("Tổng lương")){
                            bieuDo.ThemDuLieuBieuDo(thongKeCongNhanDAO.tongLuongTrongNam(cmbTuNam.getSelectedItem().toString()));
                            bieuDo.HienThiBieuDo();
                        }
                        else{
                            bieuDo.ThemDuLieuBieuDo(thongKeCongNhanDAO.topNamCongNhanTheoLuongTrongNam(tieuChi1, tieuChi2, tuNam));
                            bieuDo.HienThiBieuDo();
                        }
                    ...
                    if(tieuChi1.equalsIgnoreCase("Lương")){
                        if(tieuChi2.equalsIgnoreCase("Tổng lương")){
                            bieuDo.ThemDuLieuBieuDo(thongKeCongNhanDAO.tongLuongTheoKhoangThoiGian(tuThang, tuNam, denThang, denNam));
                            bieuDo.HienThiBieuDo();
                        }
                        else{
                            bieuDo.ThemDuLieuBieuDo(thongKeCongNhanDAO.TopNamCongNhanTheoKhoangThoiGian(tuThang, tuNam, denThang, denNam, tieuChi1, tieuChi2));
                            bieuDo.HienThiBieuDo();
                        }
    ...
    private void initComponents() {
        ...
        lblTo.setText("Tổ");
        jPanel26.add(lblTo, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 90, -1, -1));
        ...
        jPanel26.add(cmbTo, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 90, -1, -1));
        ...
        btnInBangThongKe.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        cmbTieuChi1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Lương", "Công đoạn" }));
        ...
        cmbTieuChi2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Top 5 công nhân lương cao nhất", "Top 5 công nhân lương thấp nhất" }));
